   ...
   <div class="content">
            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update   Agent Plan</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form id="form" method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('edit-agentplan-process',$id)}}">
                        ...
                        @csrf
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Plan Name" value="{{ $data->name }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="duration" class="form-control" placeholder="Enter Duration" value="{{ $data->duration }}">
