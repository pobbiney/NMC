@php $pageName = "setup"; $subpageName = "add_agent"; @endphp
            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add New Agent Package</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                       <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">List All Agent Packages  </h5>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a data-bs-toggle="modal" id="showmodal2" data-bs-target="#basicModal2" data-url="{{ route('agent-package-id',$packages->id)  }}" type="button"  class="btn   btn-success" data-bs-toggle="tooltip" data-bs-placement="top"  data-bs-custom-class="tooltip-info" title="Edit Packages"  ><i class="tf-icons ti ti-edit" style="color: white"></i></a>
                                                 <a onclick="return confirm( 'Are you sure you want to delete this Package?')" href=" {{ url('Agent-Packages/'.$packages->id).'/delete' }}"  class="btn btn-danger delete-btn"  ><i class="tf-icons ti ti-trash" style="color: white"></i></a>
                                                </td>
                                            </tr>
                                             @php
                                            $i++;
...
@include('setup.edit-agent-package');
@include('setup.agent-packages-modal');
@endsection
