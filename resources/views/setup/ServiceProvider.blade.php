   ...
   <div class="content">
            ...
            <div class="page-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add New Service Provider</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form id="form" method="post" enctype="multipart/form-data" autocomplete="off" action="{{route('add-service-provider-process')}}">
                       ...
                       @csrf
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Enter Service Provider's Name">
